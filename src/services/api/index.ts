...
export const getDataSimple = async (url = '', options: APIOptions = {}): Promise<ApiResponse> => {
...
export const postDataSimple = async (url = '', payload: any, options: APIOptions = {}): Promise<ApiResponse> => {
  const finalUrl = `${basePath}${url}`;
